...
const EquipmentModelForm = ({
  ...
  const {
    ...
    data: dataPositions,
  } = useQuery(POSITIONS_QUERY_COMPACT);
  const {
  ...
  if (errorOrganizations || errorPositions)
    return `Ошибка! ${errorOrganizations?.message || errorPositions?.message}`;
            ...
            {!loading ? (
              <>
                ...
                <Form.Item
                  ...
                  label="Имя"
                  rules={[
                    { required: true, message: "Пожалуйста, заполните имя" },
                  ]}
                >
                  <Input />
                </Form.Item>
                  ...
                  <>
                    ...
                    <AutoCompleteFormItem
                      ...
                      rulesValidationMessage={
                        "Пожалуйста, укажите должность в организации"
                      }
                    >
                      <CustomAutoComplete

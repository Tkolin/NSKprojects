        ...
        children: [
          ...
          },
          {
            ...
            children: [
              ...
              {
                label: "Типы техники",
                key: "/references/equipment_group/table",
                icon: <EyeOutlined />,
                children: null,
                permission: ["read-equipment-group"],
              },
              {
    ...
    children: [
      {
        ...
        key: "/computing/parameters",
        icon: null,
        permission: ["read-parameters", "create-parameters"],
        children: [
          {
            label: "Создать табличный параметр",
            key: "/computing/parameters/form",
            icon: null,
            children: null,
          ...
          },
          {
            ...
            key: "/computing/parameters/table",
            icon: null,
            children: null,
            permission: ["read-parameters"],
          },
        ],
      },
      {
        label: "Табличные параметры",
        key: "/computing/reference",
        icon: null,
        permission: ["computing"],
        children: [
          {
            label: "Создать табличный параметр",
            key: "/computing/reference/form",
            icon: null,
            children: null,
            permission: ["computing"],
          },
      ...
      {
        label: "Вычисления",
        key: "/computing/module",
        icon: null,
        permission: ["computing"],
        children: [
          {
            label: "Создать модуль расчёта",
            key: "/computing/module/creater",
            icon: null,
            children: null,
            permission: ["computing"],
          },
      ...
      },
      {
        ...
        key: "/project/tech_ref",
        icon: null,
        permission: ["computing"],
        children: [
          {
            label: "Создать раздел ТЗ",
            key: "/project/tech_ref/form/chapter",
            icon: null,
            children: null,
            permission: ["computing"],
          },
          {
            ...
            key: "/project/tech_ref/table/structure",
            icon: null,
            children: null,
            permission: ["computing"],
          },
          {
            ...
            key: "/project/tech_ref/table/manager",
            icon: null,
            children: null,
            permission: ["computing"],
          },
      ...
      {
        label: "Формулы",
        key: "/computing/formuls",
        icon: null,
        permission: ["computing"],
        children: [
          {
            label: "Создать формулу",
            key: "/computing/formuls/form",
            icon: null,
            children: null,
            permission: ["computing"],
          },

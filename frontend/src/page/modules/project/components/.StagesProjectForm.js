...
import {
    ...
    TEMPLATE_STAGES_TYPE_PROJECTS_QUERY
...
import {
    CONTACTS_QUERY_COMPACT, ORGANIZATIONS_QUERY_COMPACT,
...
const StagesProjectForm = ({localObject, initialObject, onCompleted}) => {
    ...
    const nameModel = 'Этапы на проекте"';
    ...
    const [stageAutoComplete, setStageAutoComplete] = useState({options: [], selected: 0});

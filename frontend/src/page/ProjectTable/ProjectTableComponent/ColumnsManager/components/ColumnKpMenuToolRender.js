        ...
        <>
            ...
            <Space.Compact align="start" direction={"vertical"}>
                ...
                <StyledButtonGreen style={{height: 32}} type={"text"} icon={<CheckSquareOutlined/>}
                                   onClick={() =>openNotification('top', 'warring', `TODO: Просит загрузить подписанный договор, и првоеряет данные у проекта`)}/>
                <Popconfirm
            ...
            >
                <Space direction={"vertical"}  style={{width: left ? 400 : 1150}}>
                    <Alert style={{marginBottom: 10}} type={"warning"} message={
                        <Text strong>Сохраните перед уходом, компонент в разработке</Text>}/>
                    <Space.Compact block style={{width: left ? 400 : 1150}}>
                    ...
                    </Space.Compact>
                    {
                        left ? (
                            ...
                            (
                                <StageToProjectForm project={record}/>
                            )
                    }

...
// import CRUDBlock from "./MenuManager/components/CRUDBlock";
//
...
//     )
// }
// const ColumnWorkingMenuToolRender = ({record, text, onUpdated, expandable}) => {
...
//                         {(isIrdFull && record.contract_file_id) && <CustomDatePicker value={selectedDateStartWork}
...
//         ;
// }
// export default ColumnWorkingMenuToolRender;
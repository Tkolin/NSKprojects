...
class ProjectContractGeneratorService extends DocumentGeneratorService
{
    ...
    public function generate(array $data)
    {
        ...
        $this->replacements = [
            ...
            'myOrg.full_name' => $myOrg['full_name'] ?? '(данные отсутствуют)' ?? null,
            ...
            'myOrg.director.position.name' => $myOrg['director']['position']['name'] ?? '(данные отсутствуют)' ?? null,
            'project.name' => $projectData['name'] ?? '' ?? null,
            'myOrg.INN' => $myOrg['INN'] ?? '(данные отсутствуют)' ?? null,
            'myOrg.KPP' => $myOrg['KPP'] ?? '(данные отсутствуют)' ?? null,
            'myOrg.address_legal' => $myOrg['address_legal'] ?? '(данные отсутствуют)' ?? null,
            'myOrg.OGRN' => $myOrg['OGRN'] ?? '(данные отсутствуют)' ?? null,
            'myOrg.legal_form' => $myOrg['legal_form']['group']['specification'] ?? '(данные отсутствуют)' ?? null,
            'myOrg.email' => $myOrg['email'] ?? '(данные отсутствуют)' ?? null,
            'myOrg.styled_phone' => $formattedPhone ?? '(данные отсутствуют)' ?? null,
            'myOrg.BIK.bik' => $myOrg['bik']['BIK'] ?? '(данные отсутствуют)' ?? null,
            'myOrg.BIK.name' => $myOrg['bik']['name'] ?? '(данные отсутствуют)' ?? null,
            'myOrg.BIK.correspondent_account' => $myOrg['bik']['correspondent_account'] ?? '(данные отсутствуют)' ?? null,
            'myOrg.payment_account' => $myOrg['payment_account'] ?? '(данные отсутствуют)' ?? null,
            'project.avansPecent' => $projectData['prepayment'] ?? null,
            'project.price' => $projectData['price'] ?? '(данные отсутствуют)' ?? null,
            'project.number' => $projectData['number'] ?? '(данные отсутствуют)' ?? null,
            "project.typeProject.Specification" => $projectData["type_project_document"]["group"]["technical_specification"]['name'] ?? '(данные отсутствуют)' ?? null,
            ...
            'projectOrganization.director.position' => $projectData["organization_customer"]['director']['position']['name'] ?? '(данные отсутствуют)' ?? null,
            'projectOrganization.INN' => $projectData["organization_customer"]['INN'] ?? '(данные отсутствуют)' ?? null,
            'projectOrganization.full_name' => $projectData["organization_customer"]['full_name'] ?? '(данные отсутствуют)' ?? null,
            ...
            'projectOrganization.KPP' => $projectData["organization_customer"]['KPP'] ?? '(данные отсутствуют)' ?? null,
            'projectOrganization.address_legal' => $projectData["organization_customer"]['address_legal'] ?? '(данные отсутствуют)' ?? null,
            'projectOrganization.OGRN' => $projectData["organization_customer"]['OGRN'] ?? '' ?? null,
            'projectOrganization.payment_account' => $projectData["organization_customer"]['payment_account'] ?? '(данные отсутствуют)' ?? null,
            'projectOrganization.BIK.bik' => $projectData["organization_customer"]['bik']['BIK'] ?? '(данные отсутствуют)' ?? null,
            'projectOrganization.BIK.name' => $projectData["organization_customer"]['bik']['name'] ?? '(данные отсутствуют)' ?? null,
            'projectOrganization.BIK.correspondent_account' => $projectData["organization_customer"]['bik']['correspondent_account'] ?? '(данные отсутствуют)' ?? null,
